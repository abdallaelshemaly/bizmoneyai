...
export default function BizMoneyLoader({
  ...
  return (
    <div className={`relative isolate flex w-full items-center justify-center overflow-hidden px-6 py-10 ${shellClassName}`}>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(20,184,166,0.24),transparent_34%),radial-gradient(circle_at_bottom_right,_rgba(15,23,42,0.28),transparent_42%),linear-gradient(180deg,#071a2f_0%,#0f172a_58%,#12233e_100%)]" />
      <div className="absolute inset-0 opacity-70 [background-image:linear-gradient(135deg,rgba(255,255,255,0.08)_0,rgba(255,255,255,0)_32%,rgba(20,184,166,0.12)_100%)]" />

      <div className="relative flex flex-col items-center text-center">
        <div className="relative">
          <div className="absolute inset-3 rounded-full bg-emerald-400/25 blur-3xl" />
          <div className="bizmoney-loader-heartbeat relative rounded-full bg-white/10 p-2 shadow-[0_24px_70px_rgba(8,15,31,0.55)] ring-1 ring-white/10 backdrop-blur">
            <Image
        ...
        <div className="mt-5 space-y-2">
          <p className="text-[0.72rem] font-semibold uppercase tracking-[0.38em] text-emerald-300/80">BizMoneyAI</p>
